...
const Details = () => {
    ...
    useEffect(() => {
        fetch(`https://assignment-10-server-c2w58adsr-sakibs-projects-d783f29e.vercel.app/getCartItems/${id}`)
            .then(res => res.json())
    ...
    const handleAddToCart = () => {
        ...
        fetch(`https://assignment-10-server-c2w58adsr-sakibs-projects-d783f29e.vercel.app/addItem/${id}`, {
            method: "PUT",
            headers: {
